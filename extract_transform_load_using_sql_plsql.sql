...
truncate table transaction_payment;
EXECUTE DBMS_STATS.GATHER_TABLE_STATS (USER,'TRANSACTION_PAYMENT');

select systimestamp, 'loading using sql plsql' as status from dual;
exec transaction_payment_etl.load_target_using_sql_plsql;
commit;
